...
public class MLSparseFeature implements Serializable {
    ...
    public MLFeatureTransform[] getFeatureTransforms() {
        return this.featTransforms;
    }
    
    public void setFeatureTransforms(final MLFeatureTransform[] featTransformsP) {
        if (this.infMode() == true) {
            throw new IllegalStateException("can't change transforms for " +
                    "finalized feature");
        }
        this.featTransforms = featTransformsP;
    }
