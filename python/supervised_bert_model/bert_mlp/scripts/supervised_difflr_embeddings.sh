...
cd ..
CUDA_VISIBLE_DEVICES=0,1,2,3 python extract_embeddings.py \
--model_type=bert \
...
--mlp_train=old_split/Valid.sav \
--mlp_val=old_split/Valid.sav \
--tweet_id_to_text_file=/home/layer6/recsys/clean/tweets_only/test_tweet_tokens.p \
--fp16 \
--continue_training_path=/home/layer6/recsys/unsupervised_kevin/checkpoints/supervised_difflr/checkpoint-21000/ \
--dataset_to_export=test \
--batch_size=512
