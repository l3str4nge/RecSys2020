...
class Trainer:
    ...
    def get_train_dataloader(self) -> DataLoader:
        if self.args.use_bucket_iterator:
            ...
            train_sampler = BySequenceLengthSampler(self.train_dataset, bucket_boundaries, batch_size=self.args.train_batch_size, drop_last=False)

            data_loader = DataLoader(self.train_dataset, batch_size=1, 
    ...
    def get_eval_dataloader(self, eval_dataset: Optional[Dataset] = None) -> DataLoader:
        ...
        if self.args.use_bucket_iterator:
            ...
            bucket_boundaries = [0, 20, 30, 40, 50, 60, 70, 80, 90, 101]
            eval_sampler = BySequenceLengthSampler(eval_dataset, bucket_boundaries, batch_size=self.args.eval_batch_size, drop_last=False)

            data_loader = DataLoader(eval_dataset, batch_size=1, 
    ...
    def train(self, model_path: Optional[str] = None):
        ...
        if self.args.max_steps > 0:
            ...
            t_total = int( (len(self.train_dataset)//self.args.train_batch_size) // self.args.gradient_accumulation_steps * self.args.num_train_epochs)
        ...
        for epoch in train_iterator:
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if self.global_step % 100 == 0:
                    ...
                    self.tb_writer.add_scalar('train loss', tr_loss-temp_loss, self.global_step)
