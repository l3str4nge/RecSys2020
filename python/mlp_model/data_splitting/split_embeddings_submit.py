...
input_folder = "/data0/xlmr_new_checkpoint146000/submit"
segments = sorted(glob.glob(join(input_folder, "*mean*.p")))
print("Extracting embeddings from {} segments ...".format(len(segments)))

tid_to_row = pickle.load(open("/data6/old_split_3chunks/kevin_data/tweet_id_to_row_submit.p", "rb"))
...
print("Saving ... ")
np_mmp = np.memmap(join("/data6/split_embeddings_3_chunks_old_data/xlmr_146000/submit_emb.p"), dtype='float32', mode='w+', shape=emb_matrix.shape)
